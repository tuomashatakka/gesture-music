/**
 * MIDI value types and helpers. Ported from the sibling hand-midi-controller
 * app so the gesture app shares one MIDI vocabulary.
 */
...
export interface MidiMessage {
  type:        'noteon' | 'noteoff' | 'cc' | 'pitchbend' | 'other'
  channel:     number
  note?:       number
  velocity?:   number
  controller?: number
